...
#pragma warning disable SA1402
    ...
    public class ObjectPathTests
    {
        ...
        public void TryGetPathValue()
        {
            ...
            {
                Assert.AreEqual(test, ObjectPath.GetPathValue<object>(test, string.Empty));
        ...
        public void SetPathValue()
        {
            ...
            Assert.AreEqual(dateISO, ObjectPath.GetPathValue<string>(test, "date.string.iso"));
            Assert.AreEqual(dateISO, ObjectPath.GetPathValue<string>(test, "date.string.jtoken.iso"));
            Assert.AreEqual(dateISO, ObjectPath.GetPathValue<string>(test, "date.object.iso"));
            Assert.AreEqual(dateISO, ObjectPath.GetPathValue<string>(test, "date.object.jtoken.iso"));
...
#pragma warning restore SA1121 // Use built-in type alias
        ...
        [TestMethod]
        public void NullComplexType()
        {
            var nested = new Nested();
            Assert.IsFalse(ObjectPath.TryGetPathValue<object>(nested, "Options", out var result));
            Assert.IsNull(result);
            Assert.IsFalse(ObjectPath.TryGetPathValue<Options>(nested, "Options", out var options));
            Assert.IsNull(options);
            // Assert.IsNull(ObjectPath.GetPathValue<object>(nested, "Options"));
            // Assert.IsNull(ObjectPath.GetPathValue<Options>(nested, "Options"));

            nested.Options = new Options();
            result = ObjectPath.GetPathValue<object>(nested, "Options");
            Assert.IsNotNull(result);
            options = ObjectPath.GetPathValue<Options>(nested, "Options");
